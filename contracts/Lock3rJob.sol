...
contract Lock3rJob {
    ...
    ILock3rHelper constant LK3RH = ILock3rHelper(0x0);
    ...
    function update(address tokenA, address tokenB) external {
        require(LK3R.isKeeper(msg.sender), "Lock3rJob::update: not a valid keeper");
        JOB.update(tokenA, tokenB);
        LK3R.workReceipt(msg.sender, LK3RH.getQuoteFor(1e18));
    }
}