...
// File: contracts\interfaces\Lock3r\ILock3rV1Helper.sol
...
// File: contracts\libraries\Lock3rV1Library.sol
...
contract Lock3r is ReentrancyGuard {
    ...
    uint public totalSupply = 200000e18; // Fixed supply of 200,000
    ...
    /// @notice 2 day to bond to become a locker
    uint constant public BOND = 2 days;
    /// @notice 14 days to unbond to remove funds from being a locker
    ...
    function addLK3RCredit(address job, uint amount) external {
        require(msg.sender == governance, "addLK3RCredit: !gov");
